...
{
    public class CustomSelectList : CustomMultiSelectList
    {
        ...
        public CustomSelectList(IEnumerable items, string dataValueField, string dataTextField, object selectedValue)
